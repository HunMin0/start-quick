      ...
      <div class="option-grid">
        <div class="option">
          <div class="option-title">
            <h1>이용약관</h1>
            <p> 이용약관 URL&emsp;I&emsp;http://webtp.maxidc.com/?mode=policy</p>
          </div>

          <div class="option-setting">
            <div class="option-items-terms">
              <div class="item-title">
                <label for="mata-tag">이용약관</label>
              </div>
              <div class="item-option">
                <textarea name="mata-tag" id="mata-tag" cols="30" rows="10" placeholder="표준약관을 활용하여 수정하세요.">
제1조 목적
...
이 약관은 <사이트 개설일>부터 시행합니다.
      ...
      <div class="option-grid">
        <div class="option">
          <div class="option-title">
            <h1>개인정보처리방침</h1>
            <p> 개인정보처리방침 약관 URL&emsp;I&emsp;http://webtp.maxidc.com/?mode=policy</p>
          </div>

          <div class="option-setting">
            <div class="option-items-terms">
              <div class="item-title">
                <label for="mata-tag">개인정보처리방침</label>
              </div>
              <div class="item-option">
                <textarea name="mata-tag" id="mata-tag" cols="30" rows="10" placeholder="표준 개인정보 처리방침 약관을 활용하여 수정하세요.">
